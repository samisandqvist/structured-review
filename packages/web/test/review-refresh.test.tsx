    ...
    flows: [
      {
        ...
        depth: 0,
        affected: true,
        changedStableIds: [node.stableId],
        entryStableId: node.stableId,
        entryReasons: ["exported"],
        entryConfidence: 0.7,
