<!-- packages/skill/skill.md — source of truth for the skill instructions.
     Both host packages' skills/structured-review/SKILL.md are GENERATED from this file
...
<!-- srev-invocation:start (build-plugin.mjs replaces this region with the plugin-mode invocation) -->
All orchestration goes through `srev` (built binary: `packages/skill/dist/cli.js`;
